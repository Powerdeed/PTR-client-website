...
export default function FeatureContainer({
  ...
  return (
    <div
      className={`relative ${globalState.smallScreen ? "w-28 h-28" : "w-40.5 h-40.5"} flex items-center justify-center`}
      ref={featureContainer}
      style={{ clipPath: clipPathStyle }}
    >
      <div
        className={`absolute left-1.125 top-1.125 ${globalState.smallScreen ? "w-25 h-25 text-style__small-text" : "w-37.5 h-37.5 text-style__body"} bg-white flex items-center justify-center text-center`}
