...
export default function Testimonials() {
  ...
  return (
    <div className="p-0 w-full md:px-[10%] mb-7.5 relative">
      ...
      <div
        className="relative flex gap-0 overflow-x-hidden w-full h-62.5 rounded-[10px] bg-gray-200 py-2.5"
        ref={(el) => {
      ...
      >
        {state.testimonials.length > 0 ? (
          state.testimonials.map((t, idx) => (
            <div
              key={idx}
              className="w-full md:border-r border-(--secondary-blue) flex flex-col shrink-0 relative"
