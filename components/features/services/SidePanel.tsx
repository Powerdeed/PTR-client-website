  ...
  return (
    <div className="w-full md:w-[90%] lg:w-100">
      ...
      <div className="w-full bg-(--terciary-grey) rounded-[10px] grid justify-center py-2.5 mb-1.25 lg:mb-0">
        <h3 className="text-center m-0.5">
        ...
        {topProjects.map((project, idx) => (
          <div key={idx} className="group w-full h-fit p-1.25 my-1.25">
            <div className="relative w-full h-62.5 overflow-hidden">
              <Image
                ...
                className="object-cover cursor-pointer rounded-[10px] scale-100 duration-300 hover:scale-[1.2]"
              />
            </div>
